 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
   ...
   echo "<h2>Laporan</h2>
          ...
          onclick=\"window.location.href='modul/mod_laporan/pdf_sewa_sekarang.php';\">

          <form method=POST action='modul/mod_laporan/pdf_pr.php'>
          <table>
          <tr><td colspan=2><b>Laporan Permintaan Barang Per Periode</b></td></tr>
